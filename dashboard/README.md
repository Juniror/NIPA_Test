...
5.  สามารถ sort ตามวันที่ได้
6.  สามารถดูประวัติการกระทำได้ที่ปุ่ม History
7.  หากเกิดปัญหาของตั๋วไม่แสดงให้กดปุ่ม refresh
8.  สามารถกดปุ่ม logout ตรงปุ่มรูปโปรไฟล์เพื่อออกจากระบบ
